...
public class CommandMutepointsAdd implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (user.get().isOnline()) {
            user.get().getPlayer().get().sendMessage(Text.of(TextColors.RED, amount + " mutepoints have been added; you now have " + post));
        }

        src.sendMessage(Text.of(TextColors.RED, "You have added " + amount + " mutepoints to " + name + "; they now have " + post));
