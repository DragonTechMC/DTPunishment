...
import me.morpheus.dtpunishment.commands.banpoints.*;
import me.morpheus.dtpunishment.commands.mutepoints.*;
...
public class DTPunishment {
	...
	private void registerCommands() {
		...
		// We will have to use the injector to get the commands from the container
		// since we couldn't setup the child injector before the plugin was instantiated
		// alternatively we could create an init class that we resolve from the container
		...
		CommandSpec showBanpoints = CommandSpec.builder()
				...
				.executor(childInjector.getInstance(CommandBanpointsShow.class))
				.build();
		...
		CommandSpec addBanpoints = CommandSpec.builder()
				...
				.executor(childInjector.getInstance(CommandBanpointsAdd.class))
				.build();
		...
		CommandSpec removeBanpoints = CommandSpec.builder()
				...
				.arguments(GenericArguments.onlyOne(GenericArguments.user(Text.of("player"))),
						GenericArguments.onlyOne(GenericArguments.integer(Text.of("amount"))))
				.executor(childInjector.getInstance(CommandBanpointsRemove.class))
				.build();
		...
		CommandSpec showMutepoints = CommandSpec.builder()
				...
				.arguments(GenericArguments.onlyOne(GenericArguments.user(Text.of("player"))))
				.executor(childInjector.getInstance(CommandMutepointsShow.class))
				.build();
		...
		CommandSpec addMutepoints = CommandSpec.builder()
				...
				.arguments(GenericArguments.onlyOne(GenericArguments.user(Text.of("player"))),
						GenericArguments.onlyOne(GenericArguments.integer(Text.of("amount"))))
				.executor(childInjector.getInstance(CommandMutepointsAdd.class))
				.build();
		...
		CommandSpec removeMutepoints = CommandSpec.builder()
				...
				.arguments(GenericArguments.onlyOne(GenericArguments.user(Text.of("player"))),
						GenericArguments.onlyOne(GenericArguments.integer(Text.of("amount"))))
				.executor(childInjector.getInstance(CommandMutepointsRemove.class))
				.build();
		...
		CommandSpec playerInfo = CommandSpec.builder()
				...
				.executor(childInjector.getInstance(CommandPlayerInfo.class))
				.build();
		...
		CommandSpec addWord = CommandSpec.builder()
				...
				.executor(childInjector.getInstance(CommandWordAdd.class))
				.build();
		...
		CommandSpec unmute = CommandSpec.builder()
				...
				.arguments(GenericArguments.onlyOne(GenericArguments.user(Text.of("player"))))
				.executor(childInjector.getInstance(CommandUnmute.class))
				.build();
		...
		CommandSpec reloadConfig = CommandSpec.builder()
				...
				.executor(childInjector.getInstance(CommandReloadConfig.class))
				.build();
