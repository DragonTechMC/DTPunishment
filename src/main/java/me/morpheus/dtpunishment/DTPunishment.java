...
import me.morpheus.dtpunishment.commands.CommandLastOffence;
...
import me.morpheus.dtpunishment.commands.CommandWordList;
import me.morpheus.dtpunishment.commands.CommandWordRemove;
...
public class DTPunishment {
	...
	private void registerCommands() {
		...
		CommandSpec addWord = CommandSpec.builder().permission("dtpunishment.admin.bannedwords")
		...
		CommandSpec removeWord = CommandSpec.builder().permission("dtpunishment.admin.bannedwords")
				...
				.executor(childInjector.getInstance(CommandWordRemove.class)).build();
		...
		CommandSpec listWords = CommandSpec.builder().permission("dtpunishment.admin.bannedwords")
				...
				.executor(childInjector.getInstance(CommandWordList.class)).build();
		...
		CommandSpec lastOffence = CommandSpec.builder().permission("dtpunishment.admin.bannedwords")
				...
				.arguments(GenericArguments.onlyOne(GenericArguments.user(Text.of("player"))))
				.executor(childInjector.getInstance(CommandLastOffence.class)).build();
		...
		CommandSpec adminCmd = CommandSpec.builder().permission("dtpunishment.admin")
				...
				.child(unmute, "unmute").child(addWord, "addwords").child(listWords, "listwords")
				.child(removeWord, "removewords").child(lastOffence, "lastoffence").build();
